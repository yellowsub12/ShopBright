    ...
    <div class="amazon-footer-lists">
      <div class="amazon-row">
        <div class="amazon-col  amazon-col--30">
          <a href="/" class="amazon-footer-logo"><img src="../imgs/Logo.png" alt="Amazon Logo" class="amazon-footer-logo-image" /></a>
        </div>
        ...
        <div class="amazon-col  amazon-col--30">
          <h4 class="amazon-footer-title">SOEN-341 Team 12</h4>
          <p4 class="amazon-footer-text">This is our team project!</p4>
        </div>
      </div> 
    </div>
    <div class="amazon-sub-footer">
      <div class="amazon-row">
        <div class="amazon-col  amazon-col--50">
          <p class="amazon-footer-text">Copyright © 2022</p>
        </div>
        <div class="amazon-col  amazon-col--50">
          <ul class="amazon-footer-list">
            <a href="#" class="amazon-footer-link">Terms &amp; Conditions&emsp;</a><a href="#" class="amazon-footer-link">Cookies &amp; Internet Advertising&emsp;</a><a href="#" class="amazon-footer-link">Privacy Notice</a>
          </ul>
        </div>
      </div>
    </div>
